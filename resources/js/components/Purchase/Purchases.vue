                 ...
                 <tbody>
                  <tr v-for="purchase in purchases.data" :key="purchase.id">
                    ...
                    <td>
                      ...
                      <br/>
                      <small class="text-muted">ক্রয় রশিদঃ {{ purchase.code }}</small>
                    </td>
                    <td>
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <v-select placeholder="ডিলার/ভেন্ডর (অপশনে না থাকলে লিখুন)" :options="vendors" :reduce="id => id" label="name" v-model="form.vendor" taggable ref='vendorSelect' :class="{ 'is-invalid': form.errors.has('vendors') }"></v-select>
