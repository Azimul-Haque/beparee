    ...
    <div class="content">
       <div class="content-header" v-if="$gate.isAdminOrAssociated('sale-page', this.$route.params.code)">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">পণ্য বিক্রয়</h1>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><router-link to="/dashboard">স্টোর</router-link></li>
                  <li class="breadcrumb-item active">পণ্য বিক্রয়</li>
                </ol>
              </div>
            </div>
          </div>
            ...
            <div class="card">
              <form @submit.prevent="createSale()" @keydown="form.onKeydown($event)">
                <div class="card-header">
                  <h3 class="card-title">পণ্য বিক্রয় করুন</h3>
      ...
      methods: {
          ...
          createSale() {
            ...
            this.form.post('/api/sale').then(() => {
              this.$router.push({name: 'salesPage', params: { code: this.$route.params.code }});
              toast.fire({
                type: 'success',
