              ...
              <form @submit.prevent="editmode ? updateProduct() : createProduct()" @keydown="form.onKeydown($event)">
                ...
                <div class="modal-body">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <v-select placeholder="পন্যের ধরণ নির্ধারণ (অপশনে না থাকলে লিখুন) *" :options="categories" taggable :reduce="id => id" label="name" v-model="form.productcategory" ref='categorySelect'></v-select>
