          ...
          <div class="modal-dialog"> <!-- modal-lg -->
            <div class="modal-content">
              ...
              <div class="modal-header">
                <h4 v-show="editmode" class="modal-title" id="addModalLabel">স্টোর সম্পাদনা করুন</h4>
                <h4 v-show="!editmode" class="modal-title" id="addModalLabel">নতুন স্টোর যোগ করুন</h4>
