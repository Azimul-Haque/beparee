      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          @foreach(Auth::user()->stores as $stores_for_nav)
            <li class="nav-item has-treeview @if(Request::url() == url('/store/'.$stores_for_nav->token.'/'.$stores_for_nav->code)) menu-open @endif @if(Request::url() == url('/products/'.$stores_for_nav->code)) menu-open @endif @if(Request::is('product/*/' . $stores_for_nav->code)) menu-open @endif @if(Request::url() == url('/purchases/'.$stores_for_nav->code)) menu-open @endif @if(Request::url() == url('/dues/'.$stores_for_nav->code)) menu-open @endif @if(Request::url() == url('/expenses/'.$stores_for_nav->code)) menu-open @endif @if(Request::is('expense/*/' . $stores_for_nav->code)) menu-open @endif @if(Request::url() == url('/vendors/'.$stores_for_nav->code)) menu-open @endif @if(Request::is('vendor/*/' . $stores_for_nav->code)) menu-open @endif @if(Request::is('customers/' . $stores_for_nav->code)) menu-open @endif @if(Request::is('customer/*/' . $stores_for_nav->code)) menu-open @endif @if(Request::is('staffs/' . $stores_for_nav->code)) menu-open @endif" {{-- :class="{'menu-open':menuselected == 2}" --}}>
              <a href="#" class="nav-link {{-- active --}}" {{-- @click="menuselected = 2" --}}>
