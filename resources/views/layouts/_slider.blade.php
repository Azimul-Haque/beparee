<!-- Slider
	...
	<div id="rev_slider_34_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
		<ul>	<!-- SLIDE  -->
			<li data-index="rs-129" data-transition="parallaxvertical" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="include/rs-plugin/demos/assets/images/newscarousel1-100x50.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="দোকানখাতা" data-description="একটি অনলাইন ভিত্তিক দোকান ব্যবস্থাপনা পদ্ধতি ">
				<!-- MAIN IMAGE -->
				<img src="{{ asset('vendor/canvas/include/rs-plugin/demos/assets/images/newscarousel1.jpg') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
				<!-- LAYERS -->
				...
				<div class="tp-caption Newspaper-Subtitle   tp-resizeme rs-parallaxlevel-0"
					...
					style="z-index: 7; white-space: nowrap;">দোকানখাতা
				</div>

				<!-- LAYER NR. 4 -->
				<a class="tp-caption Newspaper-Button rev-btn  rs-parallaxlevel-0"
					...
					data-responsive_offset="on"
					data-responsive="off"
					href="#section-features-homepage"
					style="z-index: 8; white-space: nowrap;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;">বিস্তারিত পড়ুন
				</a>
			</li>
			<!-- SLIDE  -->
			<li data-index="rs-130" data-transition="parallaxvertical" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="include/rs-plugin/demos/assets/images/newscarousel2-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="হিসাব নিকাশ " data-description="সকল হিসাব নিকাশ নিখুঁতভাবে প্রদান করে ">
				<!-- MAIN IMAGE -->
				<img src="{{ asset('vendor/canvas/include/rs-plugin/demos/assets/images/newscarousel2.jpg') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
				<!-- LAYERS -->
				...
				<div class="tp-caption Newspaper-Subtitle   tp-resizeme rs-parallaxlevel-0"
					...
					style="z-index: 7; white-space: nowrap;">হিসাব নিকাশ
				</div>
			...
			<!-- SLIDE  -->
			<li data-index="rs-131" data-transition="parallaxvertical" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="include/rs-plugin/demos/assets/images/newscarousel6-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="রিয়েল টাইম মনিটরিং " data-description="পৃথিবীর যেকোনো প্রান্ত থেকে মনিটরিং করার সুবিধা ">
				<!-- MAIN IMAGE -->
				<img src="{{ asset('vendor/canvas/include/rs-plugin/demos/assets/images/newscarousel6.jpg') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
				<!-- LAYERS -->
				...
				<div class="tp-caption Newspaper-Subtitle   tp-resizeme rs-parallaxlevel-0"
					...
					style="z-index: 7; white-space: nowrap;">রিয়েল টাইম মনিটরিং 
				</div>
			...
			<!-- SLIDE  -->
			<li data-index="rs-132" data-transition="parallaxvertical" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="include/rs-plugin/demos/assets/images/newscarousel5-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="রিপোর্ট " data-description="১০০ এর অধিক বিষয়ভিত্তিক রিপোর্ট প্রদান করে">
				<!-- MAIN IMAGE -->
				<img src="{{ asset('vendor/canvas/include/rs-plugin/demos/assets/images/newscarousel5.jpg') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
				<!-- LAYERS -->
				...
				<div class="tp-caption Newspaper-Subtitle   tp-resizeme rs-parallaxlevel-0"
					...
					style="z-index: 7; white-space: nowrap;">রিপোর্ট 
				</div>
